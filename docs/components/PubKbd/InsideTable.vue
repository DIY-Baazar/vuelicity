    ...
    <pub-table>
        ...
        <pub-table-body>
            ...
            <pub-table-row>
                ...
                <pub-table-cell>Ensure elements with ARIA role="button" can be activated with both key
                    commands</pub-table-cell>
            </pub-table-row>
            <pub-table-row>
                <pub-table-cell>
                    <span class="inline-flex gap-1">
                        <pub-kbd>
                            <template #icon>
                                <svg aria-hidden="true" class="mx-1 h-2.5 w-2.5 -rotate-90" fill="none"
                    ...
                    <span class="inline-flex gap-1">
                        <pub-kbd>
                            <template #icon>
                                <svg aria-hidden="true" class="mx-1 h-2.5 w-2.5 rotate-180" fill="none"
                                    viewBox="0 0 6 10" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 9L5 5L1 1" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="2" />
                                </svg>
                        ...
                        <pub-kbd>
                            <template #icon>
                                <svg aria-hidden="true" class="mx-1 h-2.5 w-2.5" fill="none" viewBox="0 0 6 10"
