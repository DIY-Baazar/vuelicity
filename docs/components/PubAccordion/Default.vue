    ...
    <pub-accordion>
        <pub-accordion-panel>
            ...
            <pub-accordion-content>
                ...
                <p class="text-gray-500">
                    Our mission is to support local artisans while providing customers with a seamless shopping experience
        ...
        <pub-accordion-panel>
            ...
            <pub-accordion-content>
                ...
                <p class="text-gray-500">
                    You can enter this ID on our <a href="/track-order"
                        class="text-blue-600 hover:underline">Order Tracking</a> page to see the
        ...
        <pub-accordion-panel>
            ...
            <pub-accordion-content>
                ...
                <p class="text-gray-500">
                    Please visit our <a href="/returns" class="text-blue-600 hover:underline">Returns
                        Portal</a> to review eligibility and start your return process.
                </p>
            </pub-accordion-content>
        </pub-accordion-panel>
    </pub-accordion>
